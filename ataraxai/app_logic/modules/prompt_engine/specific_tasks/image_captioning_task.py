...
class ImageCaptioningTask(BaseTask):
    ...
    def _load_resources(self) -> None:
        print(f"ImageCaptioningTask: Loading model '{self.model_id}' to device '{self.device}'...")
    ...
    def execute(self, processed_input: Dict[str, Any], context: TaskContext, prompt_manager: PromptManager) -> str:
