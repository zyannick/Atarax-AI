...
import yaml
from ataraxai.praxis.utils.user_preferences_manager import (
...
def test_preferences_created_if_not_exist(temp_config_dir: Path):
    pm = UserPreferencesManager(config_path=temp_config_dir)
...
def test_get_and_set_preferences(temp_config_dir: Path):
    ...
    pm2 = UserPreferencesManager(config_path=temp_config_dir)
