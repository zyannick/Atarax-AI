...
#     response = await unlocked_client_with_filled_manifest.post(
...
#     response = await unlocked_client_with_filled_manifest.put(
...
#     assert (
#         data["result"] is None
#     ), "Expected result to be None for background task execution."
...
#     ), "Expected the first message to be from the user."
#     assert (
#         user_message["content"] == "Who is Marcus Aurelius?"
#     ), "User query does not match."

#     assistant_message = messages[1]
#     assert (
#         assistant_message["role"] == "assistant"
#     ), "Expected the second message to be from the assistant."
#     assert isinstance(
#         assistant_message["content"], str
#     ), "Expected assistant response to be a string."
#     assert (
#         len(assistant_message["content"]) > 0
#     ), "Expected assistant response to be non-empty."
