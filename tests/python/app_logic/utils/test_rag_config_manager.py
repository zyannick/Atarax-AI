...
from ataraxai.app_logic.utils.rag_config_manager import RAGConfigManager, RAG_CONFIG_FILENAME
...
def patch_rag_config(monkeypatch):
    ...
    import ataraxai.app_logic.utils.rag_config_manager as rag_config_manager_mod
